...
import ipn.escom.demo.entity.Rol;
import ipn.escom.demo.entity.Usuario;  // Cambié el paquete a ipn.escom.demo
import ipn.escom.demo.repository.RolRepository;  // Cambié el paquete a ipn.escom.demo.repository
...
public class AdminUserController {
    ...
    public String listarUsuarios(Model model) {
        List<Usuario> usuarios = null; // Inicializa usuarios con null o con una lista vacía
        try {
            // Usar la instancia inyectada para llamar a findAll()
            usuarios = usuarioRepository.findAll();
        } catch (Exception e) {
            e.printStackTrace();
            usuarios = List.of(); // Si hay un error, asignamos una lista vacía
        }
        model.addAttribute("usuarios", usuarios);  // Esto ya no debería lanzar el error
